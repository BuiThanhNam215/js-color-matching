...
export const getRandomColorPairs = (count) => {
  ...
  const colorList = []
  const hueList = ['red', 'orange', 'yellow', 'green', 'blue', 'purple', 'pink', 'monochorome']
...
export function showPlayAgainButton() {
  ...
  if (playAginButton) playAginButton.classList.add('show')
}

export function hidePlayAgainButton() {
  const playAginButton = getPlayAgainButton()
  if (playAginButton) playAginButton.classList.remove('show')
}
